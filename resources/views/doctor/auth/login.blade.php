...
<head>
    ...
    <title>Doctor Login | PsyCare</title>
...
<body class="flex min-h-screen items-center justify-center bg-gray-50 text-gray-900">
    <div class="w-full max-w-md rounded-lg border border-gray-200 bg-white p-8">
        <h1 class="mb-6 text-2xl font-semibold">Doctor Login</h1>

        <form method="POST" action="{{ route('doctor.login') }}" class="space-y-4">
            @csrf
            ...
            <p class="text-xs text-gray-500">
                Your username and password are provided by your medical center.
            </p>
