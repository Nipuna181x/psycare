...
@php
    $tone = match (mb_strtolower($status)) {
        'approved', 'active', 'confirmed', 'completed', 'low' => 'bg-emerald-100 text-emerald-700',
        'pending', 'moderate' => 'bg-amber-100 text-amber-700',
        'rejected', 'inactive', 'cancelled', 'elevated' => 'bg-red-100 text-red-700',
