...
<nav data-nav class="sticky top-0 z-40 border-b border-transparent px-5 transition-[background-color,backdrop-filter,border-color,box-shadow,padding] duration-300 ease-out md:px-9 [&.is-stuck]:border-border [&.is-stuck]:bg-background/70 [&.is-stuck]:shadow-sm [&.is-stuck]:backdrop-blur-lg">
    <div class="mx-auto flex max-w-[1320px] items-center justify-between gap-4 py-6 transition-[padding] duration-300 ease-out md:py-7 [.is-stuck_&]:py-4">
