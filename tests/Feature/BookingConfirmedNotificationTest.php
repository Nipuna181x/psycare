...
class BookingConfirmedNotificationTest extends TestCase
{
    ...
    public function test_patient_is_notified_once_the_booking_is_confirmed(): void
    {
        Notification::fake();
        Mail::fake();
        ...
        $this->actingAs($patient)->get(route('booking.payment.success', [
            'session_id' => 'cs_test_booking_notification',
        ]));

        Notification::assertSentTo(
            $patient,
            BookingConfirmed::class,
            fn (BookingConfirmed $notification) => $notification->appointment->is($appointment)
        );
        ...
        Http::fake(function (Request $request) {
            if ($request->method() === 'POST') {
                return Http::response([
                    'id' => 'cs_test_booking_notification',
                    'url' => 'https://checkout.stripe.com/c/pay/notification',
            ...
            return Http::response([
                ...
                'payment_intent' => ['id' => 'pi_test_booking_notification'],
            ]);
        });
    }
}
